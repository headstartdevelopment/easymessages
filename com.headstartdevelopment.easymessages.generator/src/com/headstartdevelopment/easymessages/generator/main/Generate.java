 ...
 *******************************************************************************/
package com.headstartdevelopment.easymessages.generator.main;
...
public class Generate extends AbstractAcceleoGenerator {
	 ...
	 * @generated
	 */
	public static final String MODULE_FILE_NAME = "/com/headstartdevelopment/easymessages/generator/main/generate";
	...
	public void registerPackages(ResourceSet resourceSet) {
		...
		/*
		 * This manual registration of the MessagePackage is required because we
		 * cannot expect that the plugin is installed in eclipse. For the later
		 * stand-alone execution this is important.
		 */
		if (!isInWorkspace(MessagesPackage.class)) {
