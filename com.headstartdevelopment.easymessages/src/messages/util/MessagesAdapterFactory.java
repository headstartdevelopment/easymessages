...
public class MessagesAdapterFactory extends AdapterFactoryImpl {
	...
	protected MessagesSwitch<Adapter> modelSwitch =
		new MessagesSwitch<Adapter>() {
			@Override
			public Adapter caseMessageManagement(MessageManagement object) {
				return createMessageManagementAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link messages.MessageManagement <em>Message Management</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createMessageManagementAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link messages.Message <em>Message</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
